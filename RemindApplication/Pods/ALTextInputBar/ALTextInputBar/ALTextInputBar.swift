...
open class ALTextInputBar: UIView, ALTextViewDelegate {
    ...
    */
    ...
    public let textView: ALTextView = {
        ...
        _textView.placeholder = "Note"
        _textView.placeholderColor =  #colorLiteral(red: 0.8549019694, green: 0.250980407, blue: 0.4784313738, alpha: 1)
        
        _textView.font = UIFont(name: "Helvetica", size: 17)
        _textView.textColor =  #colorLiteral(red: 0.8549019694, green: 0.250980407, blue: 0.4784313738, alpha: 1)

        _textView.backgroundColor = UIColor.clear
        
        // This changes the caret color
        _textView.tintColor =  #colorLiteral(red: 0.8549019694, green: 0.250980407, blue: 0.4784313738, alpha: 1)
